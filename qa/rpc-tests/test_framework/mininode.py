# mininode.py - Fatbit P2P network half-a-node
#
...
#
# NodeConn: an object which manages p2p connectivity to a fatbit node
...
# Objects that map to fatbitd objects, which can be serialized/deserialized
...
class msg_headers(object):
    ...
    def deserialize(self, f):
        # comment in fatbitd indicates these should be deserialized as blocks
...
class NodeConn(asyncore.dispatcher):
    ...
    def __init__(self, dstaddr, dstport, rpc, callback, net="regtest", services=1):
        ...
        print 'MiniNode: Connecting to Fatbit Node IP # ' + dstaddr + ':' \
            + str(dstport)
