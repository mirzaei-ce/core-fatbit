...
#ifndef FATBIT_QT_FATBITUNITS_H
#define FATBIT_QT_FATBITUNITS_H
...
/** Fatbit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FatbitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FatbitUnits(QObject *parent);

    /** Fatbit units.
      @note Source: https://en.fatbit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        FBT,
...
private:
    QList<FatbitUnits::Unit> unitlist;
};
typedef FatbitUnits::Unit FatbitUnit;

#endif // FATBIT_QT_FATBITUNITS_H
