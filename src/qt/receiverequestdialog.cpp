...
#include "config/fatbit-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatFatbitURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + FatbitUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatFatbitURI(info));
}
