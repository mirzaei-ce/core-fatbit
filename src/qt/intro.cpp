...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/fatbit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Fatbit Core"),
     ...
     * override -datadir in the fatbit.conf file in the default data directory
     * (to be consistent with fatbitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
