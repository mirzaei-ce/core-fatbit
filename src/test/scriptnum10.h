...
#ifndef FATBIT_TEST_SCRIPTNUM10_H
#define FATBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Fatbit Core 0.10.0, for cross-comparison.
 */
public:
