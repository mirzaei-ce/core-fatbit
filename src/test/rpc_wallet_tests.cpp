...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CFatbitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CFatbitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CFatbitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CFatbitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CFatbitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CFatbitAddress(arr[0].get_str()).Get() == demoAddress.Get());
