...
unlocked to sign the Fatbit-Qt.app bundle.
...
allowing somebody to distribute a Fatbit-Qt.app or fatbit-qt-setup.exe with a valid
...
that the fatbit-qt.exe file inside the installer had not been tampered with.
