Fatbit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/fatbit/files/Fatbit/fatbit-0.5.4/
...
http://gitorious.org/fatbit/fatbitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Fatbit-Qt notifications under Growl 1.3.
Increase required age of Fatbit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxFatbit properly when installing Fatbit-Qt over it. (Windows)
