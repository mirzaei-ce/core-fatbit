Fatbit Core version 0.9.4 is now available from:

  https://fatbit.org/bin/0.9.4/
...
this update is incompatible with the Fatbit system and could lead to consensus
forks.

Fatbit Core released binaries from https://fatbit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~fatbit/+archive/ubuntu/fatbit
- A third-party or self-compiled Fatbit Core

upgrade to Fatbit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
