Fatbit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/fatbit/files/Fatbit/fatbit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Fatbit
...
New/changed settings (command-line or fatbit.conf file)
--------------------------------------------------------
