...
This document provides guidelines for internationalization of the Fatbit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `fatbit_en.ts` remains unchanged.
